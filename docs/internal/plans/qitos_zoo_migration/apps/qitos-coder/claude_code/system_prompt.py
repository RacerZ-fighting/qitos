...
Borrowed from and aligned with the real Claude Code's prompt architecture:
7-section structure with behavioral specificity, anti-patterns, and philosophy.
"""
...
# System
 ...
 - Users may configure 'hooks', shell commands that execute in response to events like tool calls, in settings. Treat feedback from hooks as coming from the user. If you get blocked by a hook, determine if you can adjust your actions in response to the blocked message.
