---
title: "方法 Recipe"
description: "使用受维护的方法 recipe（Self-Refine、Reflexion、LATS、MoA、Magentic-One）以最少的样板代码实现经过验证的智能体模式。"
---

QitOS 提供**方法 recipe**——即可直接 import 的 Agent + Critic 组合，实现知名的智能体推理
模式。每个 recipe 封装专用状态、评论器和智能体，让你无需重写控制循环即可应用该模式。
...
要创建自定义方法 recipe，请遵循相同的 Agent + Critic 模式：
