...
# Kimi
export QITOS_MODEL_FAMILY=kimi
export QITOS_MODEL="kimi-k2-0905-preview"
...
llm = build_model_for_preset(
    family_id=os.environ["QITOS_MODEL_FAMILY"],
    model_name=os.environ["QITOS_MODEL"],
