...
_PRESETS: tuple[FamilyPreset, ...] = (
    ...
    FamilyPreset(
        id="nex",
        display_name="Nex",
        model_matchers=("nex-agi/", "nex-n2", "nex-ii"),
        adapter_kind="openai-compatible",
        default_protocol="json_decision_v1",
        fallback_protocols=("xml_decision_v1", "react_text_v1"),
        tool_policy=ToolPolicy(
            ...
            fallback_delivery="prompt_injection",
            native_tool_call_preferred=True,
            notes="Nex-N2 is a Qwen3.5-MoE model served with the qwen3_coder tool parser; prefer native OpenAI-compatible tool calls.",
        ),
        context_policy=ContextPolicy(
            context_window_hint=262_144,
            fallback_context_window=131_072,
            notes="Nex-N2 (qwen3_5_moe) advertises max_position_embeddings=262144 (256k).",
        ),
        notes="Nex-AGI Nex-N2 family served through OpenAI-compatible endpoints (Qwen3.5-MoE lineage).",
        recommended_models=("nex-agi/nex-n2", "nex-agi/Nex-N2-Pro"),
        recommended_max_steps=30,
        recommended_max_tokens=500_000,
        recommended_retry_budget=3,
        recommended_temperature=0.2,
    ...
    FamilyPreset(
        ...
        notes="Native Anthropic Messages transport with provider block replay.",
